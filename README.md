...
*Together we developed a robot car that can drive autonomously. We use two motors, one for the rear wheels and one for the steering axle. An ultrasonic sensor to detect obstacles and a cell phone to see all the obstacles. We use the Arduino Uno microcontroller for our project.*
